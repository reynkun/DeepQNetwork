...
Implements a deep q reinforcement learning as specified by this [Deep Mind's 2015 paper](https://deepmind.com/research/dqn/).  Optionally, it includes double dueling dqn and also prioritized experience replay improvements.
...
While it should run on any computer, a tensorflow supported GPU will greatly speed up the training process by orders.  Additionally, at large amount of memory helps a bit (>16GB) when storing replay memory on memory.  
